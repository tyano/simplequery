 ...
 * @author Tsutomu YANO
 */
public class ItemConverterImpl<T> {
    private final Class<T> domainClass;
    private final DomainAttributes domainAttributes;
    private final InstanceFactory<T> instanceFactory;

    public ItemConverterImpl(Class<T> domainClass, InstanceFactory<T> factory) {
        this.domainClass = domainClass;
        this.domainAttributes = new BeanDomainAttributes(domainClass);
